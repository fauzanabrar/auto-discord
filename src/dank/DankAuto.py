...
class DankAuto:
    ...
    def postmemes(self):
        ...
        try:
            ...
            self.command2(self.choose_postmemes(message_id, custom_id1, random.choice(platforms)))

            self.command2(self.choose_postmemes(message_id, custom_id2, random.choice(meme_types)))
    ...
    def choose_components_emoji(self, arr, res={}):
        ...
        # print(res)
        try:
            components = res['components'][0]['components'] + res['components'][1]['components']
            choose = arr
            # print(choose)
            for j in choose:
                for i in components:
